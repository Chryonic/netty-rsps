...
import com.runescape.revised.config.VarBit;
...
class GameObject extends Renderable {
	...
	public RSModel getRotatedModel()
	{
		...
		{
			int k = GameClient.loopCycle - anInt1608;
			...
			anInt1608 = GameClient.loopCycle - k;
			if(aAnimation_1607 != null)
						 ...
						 int k1, int l1, boolean flag)
	{
		...
		if(l1 != -1)
		{
			...
			anInt1599 = 0;
			anInt1608 = GameClient.loopCycle;
		...
		anInt1601 = class46.variable_id_bitfield;
		anInt1602 = class46.variable_ID;
