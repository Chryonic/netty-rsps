...
label0:
	...
	private static void method227(BZ2Block class32)
	{
		int k8 = 0;
		int ai[] = null;
		int ai1[] = null;
		...
		if(BZ2Block.anIntArray587 == null)
			BZ2Block.anIntArray587 = new int[class32.anInt578 * 0x186a0];
		boolean flag19 = true;
		while(flag19) 
		{
			...
			for(int k5 = ai2[l7 - ai1[i7]]; k5 != l4;)
				...
				} else
				{
					...
					BZ2Block.anIntArray587[i6] = class32.aByteArray591[byte6 & 0xff] & 0xff;
					i6++;
					if(j5 == 0)
					{
						i5++;
			...
			for(int l2 = 0; l2 < i6; l2++)
			{
				...
				BZ2Block.anIntArray587[class32.anIntArray585[byte7 & 0xff]] |= l2 << 8;
				class32.anIntArray585[byte7 & 0xff]++;
			}

			class32.anInt581 = BZ2Block.anIntArray587[class32.anInt580] >> 8;
			class32.anInt584 = 0;
			class32.anInt581 = BZ2Block.anIntArray587[class32.anInt581];
	...
	private static byte method228(BZ2Block class32)
	{
		return (byte)method230(8, class32);
	}

	private static byte method229(BZ2Block class32)
	{
		return (byte)method230(1, class32);
	}

	private static int method230(int i, BZ2Block class32)
	{
		int j;
		do
		{
	...
	private static void method231(BZ2Block class32)
	{
		class32.anInt588 = 0;
		for(int i = 0; i < 256; i++)
