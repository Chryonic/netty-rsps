...
public class RSProjectile extends Renderable {
	...
	public RSModel getRotatedModel() {
		RSModel model = aSpotAnim_1592.getModel();
		if(model == null) {
			return null;
		}
		int j = -1;
		...
		RSModel model_1 = new RSModel(true, Class36.method532(j), false, model);
		if(j != -1) {
			model_1.method469();
			model_1.method470(j);
	...
	public RSProjectile(int i, int j, int l, int i1, int j1, int k1, int l1, int i2, int j2, int k2, int l2) {
		aBoolean1579 = false;
		aSpotAnim_1592 = GFX.cache[l2];
		anInt1597 = k1;
		anInt1580 = j2;
		anInt1581 = i2;
		anInt1582 = l1;
	...
	private final GFX aSpotAnim_1592;
