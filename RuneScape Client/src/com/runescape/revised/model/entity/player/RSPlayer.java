...
import com.runescape.revised.config.definitions.Animation;
import com.runescape.revised.config.definitions.NPCDef;
import com.runescape.revised.config.definitions.GFX;
import com.runescape.revised.config.definitions.IdentityKit;
...
import com.runescape.revised.util.TextClass;
import com.runescape.revised.util.node.Cache;

public final class RSPlayer extends RSEntity
{
	...
	public RSModel getRotatedModel()
	{
		...
		{
			GFX spotAnim = GFX.cache[super.anInt1520];
			RSModel model_2 = spotAnim.getModel();
			if(model_2 != null)
			{
				RSModel model_3 = new RSModel(true, Class36.method532(super.anInt1521), false, model_2);
				...
				RSModel aclass30_sub2_sub4_sub6_1s[] = {
						model, model_3
				};
				model = new RSModel(aclass30_sub2_sub4_sub6_1s);
			}
		}
		if(aModel_1714 != null)
		{
			if(GameClient.loopCycle >= anInt1708)
				aModel_1714 = null;
			if(GameClient.loopCycle >= anInt1707 && GameClient.loopCycle < anInt1708)
			{
				RSModel model_1 = aModel_1714;
				...
				if(super.turnDirection == 1536)
					model_1.method473();
				RSModel aclass30_sub2_sub4_sub6s[] = {
						model, model_1
				};
				model = new RSModel(aclass30_sub2_sub4_sub6s);
				if(super.turnDirection == 512)
					model_1.method473();
				else
				if(super.turnDirection == 1024)
	...
	public void updatePlayer(RSBuffer stream)
	{
		...
		for(int l = 0; l < 5; l++)
		{
			...
			if(j1 < 0 || j1 >= GameClient.playerBodyRecolours[l].length)
				j1 = 0;
			anIntArray1700[l] = j1;
		}
	...
	private RSModel method452()
	{
		if(desc != null)
		{
			...
			RSModel model = desc.method164(-1, j, null);
			return model;
		}
		long l = aLong1718;
		int k = -1;
		...
		RSModel model_1 = (RSModel) mruNodes.insertFromCache(l);
		if(model_1 == null)
		{
			boolean flag = false;
			...
			{
				if(aLong1697 != -1L)
					model_1 = (RSModel) mruNodes.insertFromCache(aLong1697);
				if(model_1 == null)
					return null;
			}
		}
		if(model_1 == null)
		{
			RSModel aclass30_sub2_sub4_sub6s[] = new RSModel[12];
			int j2 = 0;
			for(int l2 = 0; l2 < 12; l2++)
			{
				...
				if(i3 >= 256 && i3 < 512)
				{
					RSModel model_3 = IdentityKit.cache[i3 - 256].method538();
					if(model_3 != null)
						aclass30_sub2_sub4_sub6s[j2++] = model_3;
				}
				if(i3 >= 512)
				{
					RSModel model_4 = ItemDef.forID(i3 - 512).method196(anInt1702);
					if(model_4 != null)
						aclass30_sub2_sub4_sub6s[j2++] = model_4;
				}
			}

			model_1 = new RSModel(j2, aclass30_sub2_sub4_sub6s);
			for(int j3 = 0; j3 < 5; j3++)
				if(anIntArray1700[j3] != 0)
				{
					model_1.method476(GameClient.playerBodyRecolours[j3][0], GameClient.playerBodyRecolours[j3][anIntArray1700[j3]]);
					if(j3 == 1)
						model_1.method476(GameClient.skinColours[0], GameClient.skinColours[anIntArray1700[j3]]);
				}
		...
		if(aBoolean1699)
			return model_1;
		RSModel model_2 = RSModel.aModel_1621;
	...
	public RSModel method453()
	{
		...
		for(int l = 0; l < 12; l++)
		{
			...
			if(i1 >= 256 && i1 < 512)
			{
				RSModel model_1 = IdentityKit.cache[i1 - 256].method540();
				if(model_1 != null)
					aclass30_sub2_sub4_sub6s[k++] = model_1;
			}
			if(i1 >= 512)
			{
				RSModel model_2 = ItemDef.forID(i1 - 512).method194(anInt1702);
				if(model_2 != null)
					aclass30_sub2_sub4_sub6s[k++] = model_2;
			}
		}

		RSModel model = new RSModel(k, aclass30_sub2_sub4_sub6s);
		for(int j1 = 0; j1 < 5; j1++)
			if(anIntArray1700[j1] != 0)
			{
				model.method476(GameClient.playerBodyRecolours[j1][0], GameClient.playerBodyRecolours[j1][anIntArray1700[j1]]);
				if(j1 == 1)
					model.method476(GameClient.skinColours[0], GameClient.skinColours[anIntArray1700[j1]]);
			}
