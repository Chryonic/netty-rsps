...
import com.runescape.SkinList;
import com.runescape.revised.config.definitions.ModelDefinition;
import com.runescape.revised.filesystem.RSBuffer;
import com.runescape.revised.graphics.image.DrawingArea;

public final class RSModel extends Renderable {
	...
	{
		aClass21Array1661 = new ModelDefinition[i];
	...
	public static void method460(byte abyte0[], int j)
	{
		if(abyte0 == null)
		{
			ModelDefinition modelDefinition = aClass21Array1661[j] = new ModelDefinition();
			modelDefinition.anInt369 = 0;
			modelDefinition.anInt370 = 0;
			modelDefinition.anInt371 = 0;
			return;
		}
		RSBuffer stream = new RSBuffer(abyte0);
		stream.currentOffset = abyte0.length - 18;
		ModelDefinition class21_1 = aClass21Array1661[j] = new ModelDefinition();
	...
	public static RSModel method462(int j)
	{
		if(aClass21Array1661 == null)
			return null;
		ModelDefinition modelDefinition = aClass21Array1661[j];
	...
	public static boolean method463(int i)
	{
		if(aClass21Array1661 == null)
			return false;
		ModelDefinition modelDefinition = aClass21Array1661[i];
		if(modelDefinition == null)
		{
	...
	private RSModel(int i)
	{
		aBoolean1659 = false;
		ModelDefinition modelDefinition = aClass21Array1661[i];
		anInt1626 = modelDefinition.anInt369;
		anInt1630 = modelDefinition.anInt370;
		anInt1642 = modelDefinition.anInt371;
		...
		if(modelDefinition.anInt376 >= 0)
			anIntArray1655 = new int[anInt1626];
		if(modelDefinition.anInt380 >= 0)
			anIntArray1637 = new int[anInt1630];
		if(modelDefinition.anInt381 >= 0)
			anIntArray1638 = new int[anInt1630];
		else
			anInt1641 = -modelDefinition.anInt381 - 1;
		if(modelDefinition.anInt382 >= 0)
			anIntArray1639 = new int[anInt1630];
		if(modelDefinition.anInt383 >= 0)
			anIntArray1656 = new int[anInt1630];
		anIntArray1640 = new int[anInt1630];
		RSBuffer stream = new RSBuffer(modelDefinition.aByteArray368);
		stream.currentOffset = modelDefinition.anInt372;
		RSBuffer stream_1 = new RSBuffer(modelDefinition.aByteArray368);
		stream_1.currentOffset = modelDefinition.anInt373;
		RSBuffer stream_2 = new RSBuffer(modelDefinition.aByteArray368);
		stream_2.currentOffset = modelDefinition.anInt374;
		RSBuffer stream_3 = new RSBuffer(modelDefinition.aByteArray368);
		stream_3.currentOffset = modelDefinition.anInt375;
		RSBuffer stream_4 = new RSBuffer(modelDefinition.aByteArray368);
		stream_4.currentOffset = modelDefinition.anInt376;
		int k = 0;
		int l = 0;
		int i1 = 0;
		...
		stream.currentOffset = modelDefinition.anInt379;
		stream_1.currentOffset = modelDefinition.anInt380;
		stream_2.currentOffset = modelDefinition.anInt381;
		stream_3.currentOffset = modelDefinition.anInt382;
		stream_4.currentOffset = modelDefinition.anInt383;
		...
		stream.currentOffset = modelDefinition.anInt377;
		stream_1.currentOffset = modelDefinition.anInt378;
		int j2 = 0;
		int l2 = 0;
		int j3 = 0;
		int k3 = 0;
		...
		stream.currentOffset = modelDefinition.anInt384;
	...
	public RSModel(int i, RSModel aclass30_sub2_sub4_sub6s[])
	{
		aBoolean1659 = false;
		boolean flag = false;
		boolean flag1 = false;
		...
		for(int k = 0; k < i; k++)
		{
			RSModel model = aclass30_sub2_sub4_sub6s[k];
			if(model != null)
			{
		...
		{
			RSModel model_1 = aclass30_sub2_sub4_sub6s[i1];
			if(model_1 != null)
			{
	...
	public RSModel(RSModel aclass30_sub2_sub4_sub6s[])
	{
		...
		{
			RSModel model_1 = aclass30_sub2_sub4_sub6s[j1];
			if(model_1 != null)
			{
				int k1 = anInt1626;
	...
	public RSModel(boolean flag, boolean flag1, boolean flag2, RSModel model)
	{
		aBoolean1659 = false;
		anInt1626 = model.anInt1626;
		anInt1630 = model.anInt1630;
	...
	public RSModel(boolean flag, boolean flag1, RSModel model)
	{
		aBoolean1659 = false;
		anInt1626 = model.anInt1626;
		anInt1630 = model.anInt1630;
	...
	public void method464(RSModel model, boolean flag)
	{
		anInt1626 = model.anInt1626;
		anInt1630 = model.anInt1630;
		anInt1642 = model.anInt1642;
	...
	private int method465(RSModel model, int i)
	{
		int j = -1;
	...
	public static final RSModel aModel_1621 = new RSModel();
	...
	private static ModelDefinition[] aClass21Array1661;
	...
	static 
	{
		...
		modelIntArray3 = Rasterizer.hslToRgbLookupTable;
