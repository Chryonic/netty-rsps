...
public final class ItemDef // load items
{
	...
	public boolean method192(int j)
	{
		...
		if(k == -1)
			return true;
		boolean flag = true;
		if(!RSModel.method463(k))
			flag = false;
		if(l != -1 && !RSModel.method463(l))
			flag = false;
		return flag;
	}
	...
	public RSModel method194(int j)
	{
		int k = anInt175;
		int l = anInt166;
		if(j == 1)
		...
		if(k == -1)
			return null;
		RSModel model = RSModel.method462(k);
		if(l != -1)
		{
			RSModel model_1 = RSModel.method462(l);
			RSModel aclass30_sub2_sub4_sub6s[] = {
					model, model_1
			};
			model = new RSModel(2, aclass30_sub2_sub4_sub6s);
		}
	...
	public boolean method195(int j)
	{
		...
		if(l != -1 && !RSModel.method463(l))
			flag = false;
		if(i1 != -1 && !RSModel.method463(i1))
			flag = false;
		return flag;
	}

	public RSModel method196(int i)
	{
		int j = anInt165;
		int k = anInt188;
		int l = anInt185;
		...
		if(j == -1)
			return null;
		RSModel model = RSModel.method462(j);
		if(k != -1)
			if(l != -1)
			{
				RSModel model_1 = RSModel.method462(k);
				RSModel model_3 = RSModel.method462(l);
				RSModel aclass30_sub2_sub4_sub6_1s[] = {
						model, model_1, model_3
				};
				model = new RSModel(3, aclass30_sub2_sub4_sub6_1s);
			} else
			{
				RSModel model_2 = RSModel.method462(k);
				RSModel aclass30_sub2_sub4_sub6s[] = {
						model, model_2
				};
				model = new RSModel(2, aclass30_sub2_sub4_sub6s);
	...
	private void toNote() // notes the items in your inventory
	{
	...
	public static Sprite getSprite(int i, int j, int k)
	{
		...
		RSModel model = itemDef.method201(1);
		if(model == null)
			return null;
		Sprite sprite = null;
		if(itemDef.certTemplateID != -1)
	...
	public RSModel method201(int i)
	{
		...
		RSModel model = (RSModel) mruNodes2.insertFromCache(id);
		if(model != null)
			return model;
		model = RSModel.method462(modelID);
		if(model == null)
			return null;
	...
	public RSModel method202(int i)
	{
		if(stackIDs != null && i > 1)
		{
			int j = -1;
		...
		RSModel model = RSModel.method462(modelID);
		if(model == null)
			return null;
		if(modifiedModelColors != null)
		{
	...
	private void readValues(RSBuffer stream)
	{
		do
		{
			...
			if(i >= 100 && i < 110)
			{
				if(stackIDs == null) // whethre or not the items are stackable
				{
					stackIDs = new int[10];
